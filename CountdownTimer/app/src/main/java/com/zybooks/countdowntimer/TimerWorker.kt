...
class TimerWorker(context: Context, parameters: WorkerParameters) :
    ...
    private fun createTimerNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(CHANNEL_ID_TIMER, "Timer Channel", NotificationManager.IMPORTANCE_LOW)
    ...
    private fun postTimerNotification(text: String) {
        ...
        val notification = NotificationCompat.Builder(applicationContext, CHANNEL_ID_TIMER).setSmallIcon(android.R.drawable.ic_dialog_info)
